...
PLAN_CATALOGUE: dict[Plan, PlanSpec] = {
    Plan.FREE: PlanSpec(
        plan=Plan.FREE,
        label="Free",
        tagline="See what is happening on your network.",
        price_tzs=0,
    ...
    Plan.HOME: PlanSpec(
        plan=Plan.HOME,
        label="Home",
        tagline="One household, with live capture and full detection.",
        price_tzs=15_000,
        ...
        highlights=(
            ...
            "7 days of retention",
            "Live packet capture",
            "Detection engine, 12 attack classes",
            "AI Log Analyzer",
        ),
    ),
    Plan.PRO: PlanSpec(
        plan=Plan.PRO,
        label="Pro",
        tagline="For real investigation: AI packet analysis and incidents.",
        price_tzs=50_000,
    ...
    Plan.BUSINESS: PlanSpec(
        plan=Plan.BUSINESS,
        label="Business",
        tagline="All 25 modules, with no device ceiling.",
        price_tzs=150_000,
        ...
        highlights=(
            ...
            "AI Investigation and AI Rule Generator",
            "Vulnerability scanner and Forensics",
            "Network inventory",
            "25 seats",
        ),
    ),
